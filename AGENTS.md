...
# Edit Native PPTX round-trip workspace (see edit-native-pptx.md §3/§7)
uvx ppt-master pptx-to-svg "<source.pptx>" -o "projects/<slug>_<YYYYMMDD>" --inheritance-mode both --roundtrip   # Edit Native PPTX
