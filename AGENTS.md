...
uvx ppt-master svg-quality-check <project_path> --canonical-authoring
...
uvx ppt-master svg-to-pptx projects/<slug>_<YYYYMMDD> --roundtrip  # optional page_plan.json at the workspace root
```
