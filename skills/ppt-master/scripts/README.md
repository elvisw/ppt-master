...
uvx ppt-master svg-authoring-view <authoring-dir> --adopt-object <from.svg>:<element-id> --into <target.svg>
uvx ppt-master stamp-native-fallbacks <svg-file-or-directory> --write
...
uvx ppt-master svg-to-pptx <import_workspace> --roundtrip
...
Run `uvx ppt-master svg-quality-check <workspace> --roundtrip` before a
