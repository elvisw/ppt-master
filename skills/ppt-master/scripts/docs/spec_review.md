...
```bash
uvx ppt-master spec-review <project_path> --daemon
uvx ppt-master spec-review <project_path> --daemon --no-browser
uvx ppt-master spec-review <project_path> --port 6070 --timeout 7200
uvx ppt-master spec-review <project_path> --hold on
uvx ppt-master spec-review <project_path> --hold off
uvx ppt-master check-spec-annotations <project_path>
uvx ppt-master check-spec-annotations <project_path> --ack-edits
uvx ppt-master check-spec-annotations <project_path> --applied <id>
uvx ppt-master spec-review <project_path> --shutdown
```
