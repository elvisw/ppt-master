...
2. `uvx ppt-master check-spec-annotations <project_path>` — the to-do list: pending comments plus blocks the user edited directly since the last round. Read those blocks from disk; the copy in context is stale.
