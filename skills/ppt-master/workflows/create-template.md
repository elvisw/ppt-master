...
```bash
uvx ppt-master compact-svg-coordinates "<template_source>" --inplace --keep-native-frames
uvx ppt-master svg-quality-check "<template_source>" --template-mode --format <canvas_format>
```
...
```bash
uvx ppt-master template-preview-pptx "<authoring_workspace>"
```
...
```bash
uvx ppt-master template-preview-pptx "<authoring_workspace>" --force
```
