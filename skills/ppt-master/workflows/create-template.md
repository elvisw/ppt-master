...
```bash
uvx ppt-master template-preview-pptx "<authoring_workspace>"            # exports/<template_id>_template_preview.pptx
uvx ppt-master template-preview-pptx "<authoring_workspace>" --native-charts-and-tables -o "<authoring_workspace>/exports/<template_id>_template_preview_native.pptx"   # explicit native review; typed chart/table slots already compile natively in the default run
uvx ppt-master template-preview-pptx "<authoring_workspace>" --force    # intentional replacement after a fix
```
