...
COMMAND_DESCRIPTIONS = {
    ...
    "stamp-native-fallbacks": "Stamp native fallback baselines on SVG markers",
    "svg-authoring-view":     "Create lightweight SVG authoring projection",
    "text-measure":           "Measure and wrap text for SVG authoring",
    ...
    "compact-svg-styles":     "Compact SVG style declarations in template files",
