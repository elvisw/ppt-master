...
uvx ppt-master preset-shape-svg render-batch --input -   # JSON array of the same fields for several already-selected objects
uvx ppt-master preset-shape-svg describe chevron --compact  # objective identity/adjustment/connector/path facts, only for a serious candidate
