...
If `images/` is non-empty, run `uvx ppt-master analyze-images <project_path>/images` and read `analysis/image_analysis.csv` before recommending (rerun after changes).
