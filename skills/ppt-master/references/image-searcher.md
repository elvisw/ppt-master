...
```bash
uvx ppt-master image-search "<query>" --filename <name>.jpg --slide <slide_id> \
...
```bash
uvx ppt-master image-search --batch <project_path>/images/image_queries.json -o <project_path>/images --save-candidates
```
